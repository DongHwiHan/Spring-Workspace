...
public class Test {
	...
	// joinPoint : 클라이언트가 호출하는 모~든 비지니스 메서드. advice가 적용될수 있는 예비 후보
	...
	public void start() { // 서비스 수행전에 실행되는 메서드(advice)
		logger.info("ㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎ서비스 시작 됩니다ㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎ");
	}
	...
	//@After("testPointCut()")
	public void after() {
		logger.info("ㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎ서비스 취소 됩니다ㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎ");
	}
	
	// @PointCut을 작성해 놓은 메소드
	// -> PointCut의 패턴이 작성되는 부분에 testPointCut()메서드이름을 작성하면, PointCut애 정의한 패턴이 적용된다.
